    ...
    <div className="lg:sticky lg:top-8">
      <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-gray-600">Enter your information to create your account</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
              />
              <UserCircle2 className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400" />
            </div>
          </div>
